...
function CanvasFlowInner({ canvasId }: CanvasFlowComponentProps) {
  ...
  const handleZoomIn = useCallback(() => {
    ...
    setZoom(Math.min(currentZoom * 1.2, 2));
  }, [getZoom]);
  ...
  return (
    <div className="h-screen flex flex-col">
      {/* Header */}
      <header className="bg-white border-b border-slate-200 px-4 py-3 flex justify-between items-center z-50">
      ...
      <div ref={reactFlowWrapper} className="flex-1 relative">
        ...
        {/* Status Bar */}
        <div className="absolute bottom-4 left-4 bg-white rounded-lg border border-slate-200 shadow-lg px-3 py-2 z-30">
